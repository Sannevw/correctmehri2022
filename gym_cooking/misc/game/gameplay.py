...
class GamePlay(Game):
    def __init__(self, filename, world, sim_agents, level, recipe):
        Game.__init__(self, world, sim_agents, level=level, play=True)
    ...
    def on_event(self, event):
        if event.type == pygame.QUIT:
            ...
            if event.key in KeyToTuple.keys():
                ...
                interact(self.current_agent, self.level, self.world, recipe=self.recipe, max_nr=max_nr)
